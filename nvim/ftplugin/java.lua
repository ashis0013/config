...
local path_to_java_dap = '/Users/Ashis.Paul/Downloads/java-debug-0.53.1/com.microsoft.java.debug.plugin/target/'
...
local config = {
  ...
  init_options = {
    bundles = {
      vim.fn.glob(path_to_java_dap .. 'com.microsoft.java.debug.plugin-0.53.1.jar', 1)
    },
  },
}
